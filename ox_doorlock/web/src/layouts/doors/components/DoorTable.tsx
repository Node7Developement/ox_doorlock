import { Table, UnstyledButton, Text, Group, Center, Stack, Pagination, Badge } from '@mantine/core';
import {
  ColumnDef,
  flexRender,
  getCoreRowModel,
  ...
  const columns = useMemo<ColumnDef<DoorColumn>[]>(
    () => [
      ...
      },
      {
        ...
        cell: (info) => {
          const locked = Number(info.getValue()) === 1;
          return (
            <Badge color={locked ? 'red' : 'green'} variant="filled" radius="sm">
