...
const useStyles = createStyles((theme) => ({
  ...
  main: {
    width: 880,
    height: 560,
    background: 'linear-gradient(180deg, rgba(22, 18, 12, 0.985) 0%, rgba(8, 7, 6, 0.99) 100%)',
    border: `1px solid ${theme.colors.node7Gold[7]}`,
    borderRadius: 6,
    boxShadow: '0 22px 70px rgba(0, 0, 0, 0.78), inset 0 0 0 1px rgba(234, 210, 122, 0.06)',
    overflow: 'hidden',
  },
